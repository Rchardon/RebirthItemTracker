...
By default, it shows:
"Seed: {seed} / Guppy: {guppy} / Leviathan: {leviathan} / Spun: {spun} / Bookworm: {bookworm} / {version_number} / Room: {room_id} {racing_plus_version} {babies_mod_version}"
...
- General game info: {seed}, {version_number}, {room_id}
  ...
  before that variable, same for {babies_mod_version}
